kc_data = read.csv('/Users/manthanmehta/Desktop/IMT 572/kc_house_data.csv')
library(tidyverse)
library(lubridate)
...
#renovated, dist, age, 
write.csv(kc_data,'/Users/manthanmehta/Desktop/IMT 572/kc_house_data.csv', row.names = TRUE)
...
kc_neural_model = neuralnet(f ~ a + b + c + 
                              d + e - 1, kc_data_scaled, hidden = c(5,5,5,5), threshold = 0.01)
